...
* Remove Meta
*/
add_action('do_meta_boxes', 'move_wordpress_meta');
function move_wordpress_meta() {
    //
    //remove_meta_box( 'postimagediv', 'event', 'side' );
    //remove_meta_box( 'postimagediv', 'team', 'side' );
    //
    //add_meta_box('postimagediv', __('Set Event Image'), 'post_thumbnail_meta_box', 'event', 'normal', 'high');
    //add_meta_box('postimagediv', __('Set Member Photo'), 'post_thumbnail_meta_box', 'team', 'side', 'low');
}
/**END REMOVE META*/
...
$meta_boxes[] = array(
	...
	'only_on'    => array(
		...
		'template' => array( 'trigger-meta-box-with-page-template.php' )
		//'parent'   => array( 10 )
	),
    'id' => 'dynamic_meta',
    'title' => 'Dynamic Metabox',
    'pages' => array('page'),
    'context' => 'normal',
    'priority' => 'core',
    'autosave' => true,
