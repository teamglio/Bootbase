...
function bootstrapwp_styles_loader() {
    ...
    wp_enqueue_style('theme', get_template_directory_uri() . '/assets/css/theme.css', false, '1.0', 'all');
    wp_enqueue_style('font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.css', false, '3.0', 'all');
    wp_enqueue_style('slider', get_template_directory_uri() . '/assets/css/ios-slider.css', false, '1.0', 'all');
...
function bootstrapwp_scripts_loader() {
    ...
    wp_enqueue_script('bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '3.0', true);
    wp_enqueue_script('jquery-easing', get_template_directory_uri() . '/assets/js/jquery.easing-1.3.js', array('jquery'), '1.3', true);
    wp_enqueue_script('jquery-cylce', get_template_directory_uri() . '/assets/js/jquery.cycle.js', array('jquery'), '1.0', true);
    wp_enqueue_script('iosslider', get_template_directory_uri() . '/assets/js/jquery.iosslider.js', array('jquery'), '1.0', true);
    wp_enqueue_script('fadeslider', get_template_directory_uri() . '/assets/js/responsiveslides.js', array('jquery'), '1.0', true);
    wp_enqueue_script('verticalslider', get_template_directory_uri() . '/assets/js/verticalslider.js', array('jquery'), '1.0', true);
    wp_enqueue_script('colorbox', get_template_directory_uri() . '/assets/js/jquery.colorbox.js', array('jquery'), '1.0', true);
...
function bootstrapwp_widgets_init() {
    ...
    register_sidebar(
        array(
            ...
            'before_title'  => '<div class="widget-title panel-heading"><h3 class="panel-title">',
    ...
    function bootstrapwp_comment($comment, $args, $depth)
    {
        ...
        switch ($comment->comment_type) :
            ...
            case 'trackback' : ?>
                ...
                <li class="comment media panel panel-default" id="comment-<?php comment_ID(); ?>">
            ...
            default :
                ...
                <li class="comment media panel panel-default" id="li-comment-<?php comment_ID(); ?>">
                <h4 class="media-heading comment-author vcard panel-heading">
                                <?php
                        ...
                        <div class="media-body">
                            <?php if ('0' == $comment->comment_approved) : ?>
                                <p class="comment-awaiting-moderation alert alert-success"><?php _e(
                            ...
                            <p class="reply">
                                <?php comment_reply_link( array_merge($args, array(
                                            'reply_text' => __('<i class="icon-chevron-down"></i> Reply', 'bootstrapwp'),
                                            'depth'      => $depth,
